...
# 文件路径
spec_Path="./DFMediatorTool.podspec"
...
# git add .
# git commit -m "update to DFMediatorTool tag:${UpVersion}"
# git tag ${UpVersion}
# git push
# git push --tags
# pod repo push ${SpecName} DFMediatorTool.podspec --verbose --allow-warnings --use-libraries --use-modular-headers
